...
{
    public partial class StabilizeInventoryBudgetAndAuditWorkflows
    {
        private static void ApplyHistoricalActorSafeTriggerDefinitions(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                BEGIN
                    ...
                    END IF;
                    IF TG_TABLE_NAME = 'OpeningPositionVerifications'
                       AND NOT constructionms_actor_has_project_role(
                            NEW."VerifiedByUserId", 'Supervisor', batch_record."ProjectId") THEN
                    ...
                    END IF;
                    IF TG_TABLE_NAME = 'OpeningPositionDecisions'
                       AND NOT constructionms_actor_has_project_role(
                            NEW."DecidedByUserId", 'CEO', batch_record."ProjectId") THEN
                ...
                BEGIN
                    ...
                    IF NOT FOUND
                       ...
                       OR resolution_record."ResolvedByUserId" IN (
                            issue_record."IssuedByUserId", issue_record."ConfirmedByUserId") THEN
            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    ...
                    ELSIF closeout_record."Status" IN ('Approved', 'Returned') THEN
                        ...
                        END IF;
                    END IF;
                    IF TG_TABLE_NAME = 'MaterialCustodyCloseoutDecisions'
                       AND NOT constructionms_actor_has_project_role(
                            NEW."DecidedByUserId", 'Supervisor', issue_record."ProjectId") THEN
            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    ...
                    IF TG_TABLE_NAME = 'OperationalPeriodEvents' AND (
                        (
                            NEW."EventType" IN ('Opened', 'CloseSubmitted')
                            AND NOT constructionms_actor_has_project_role(
                                NEW."ActorUserId", submitter_role, period_record."ProjectId")
                        ) OR (
                            NEW."EventType" IN ('Closed', 'CloseReturned')
                            AND NOT constructionms_actor_has_project_role(
                                NEW."ActorUserId", 'CEO', period_record."ProjectId")
                        )
                    ) THEN
            ...
            migrationBuilder.Sql(
                ...
                BEGIN
                    ...
                    END IF;
                    IF TG_TABLE_NAME = 'ControlledCorrectionDecisions'
                       AND NOT constructionms_actor_has_project_role(
                            NEW."DecidedByUserId", 'CEO', correction_record."ProjectId") THEN
