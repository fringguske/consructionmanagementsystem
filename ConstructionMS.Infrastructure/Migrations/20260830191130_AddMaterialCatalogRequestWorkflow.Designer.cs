...
namespace ConstructionMS.Infrastructure.Migrations
{
    ...
    [Migration("20260830191130_AddMaterialCatalogRequestWorkflow")]
    partial class AddMaterialCatalogRequestWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.GoodsReceipt", b =>
                {
                    ...
                    b.HasIndex("SupplierId", "DeliveryNoteReference")
                        .IsUnique();
                    ...
                    b.ToTable("GoodsReceipts", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_GoodsReceipts_DeliveryNoteReference", "length(btrim(\"DeliveryNoteReference\")) > 0 AND \"DeliveryNoteReference\" = upper(btrim(\"DeliveryNoteReference\"))");
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.Material", b =>
                {
                    ...
                    b.Property<string>("NormalizedName")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("text")
                        .HasComputedColumnSql("lower(btrim(\"Name\", ' ' || chr(9) || chr(10) || chr(11) || chr(12) || chr(13)))", true);

                    b.Property<string>("NormalizedUnit")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("text")
                        .HasComputedColumnSql("lower(btrim(\"Unit\", ' ' || chr(9) || chr(10) || chr(11) || chr(12) || chr(13)))", true);
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.MaterialCatalogRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ApprovedMaterialId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MaterialCatalogRequests", t =>
                        {
                            t.HasCheckConstraint("CK_MaterialCatalogRequests_Actors_Distinct", "\"ReviewedByUserId\" IS NULL OR \"ReviewedByUserId\" <> \"SubmittedByUserId\"");

                            t.HasCheckConstraint("CK_MaterialCatalogRequests_Decision_Consistent", "(\"Status\" = 'Pending' AND \"ReviewedByUserId\" IS NULL AND \"ReviewedAt\" IS NULL AND \"ReviewNotes\" IS NULL AND \"ApprovedMaterialId\" IS NULL) OR (\"Status\" = 'Approved' AND \"ReviewedByUserId\" IS NOT NULL AND \"ReviewedAt\" IS NOT NULL AND length(btrim(\"ReviewNotes\")) >= 3 AND \"ApprovedMaterialId\" IS NOT NULL) OR (\"Status\" = 'Rejected' AND \"ReviewedByUserId\" IS NOT NULL AND \"ReviewedAt\" IS NOT NULL AND length(btrim(\"ReviewNotes\")) >= 3 AND \"ApprovedMaterialId\" IS NULL)");

                            t.HasCheckConstraint("CK_MaterialCatalogRequests_Review_After_Submission", "\"ReviewedAt\" IS NULL OR \"ReviewedAt\" >= \"SubmittedAt\"");

                            t.HasCheckConstraint("CK_MaterialCatalogRequests_Status_Valid", "\"Status\" IN ('Pending', 'Approved', 'Rejected')");
                        });
                });
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.MaterialUsageRecord", b =>
                {
                    ...
                    b.HasIndex("MaterialIssueId", "IdempotencyKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.SecurityAuditEvent", b =>
                {
                    ...
                    b.ToTable("SecurityAuditEvents", t =>
                        {
                            t.HasCheckConstraint("CK_SecurityAuditEvents_EventType", "\"EventType\" IN ('UsernameChanged', 'PasswordChanged', 'AdministratorPasswordReset', 'UserCreated', 'UserProfileUpdated', 'UserRoleChanged', 'UserActivated', 'UserDeactivated')");

                            t.HasCheckConstraint("CK_SecurityAuditEvents_Source", "\"Source\" IN ('SelfService', 'ServerRecovery', 'Administrator')");
                        });
                });
                    ...
                    b.ToTable("StockLedgerEntries", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_StockLedgerEntries_Movement", "\"MovementType\" IN ('Receipt', 'TechnicalAcceptance', 'Issue', 'TransferOut', 'TransferIn', 'TransferVarianceRecovered', 'TransferVarianceReturned', 'CountAdjustment', 'OpeningBalance', 'ReturnToStore', 'HandoverCorrection', 'ControlledCorrection')");
                        });
                });
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.StockTransfer", b =>
                {
                    ...
                    b.Property<string>("ResolutionDisposition")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
                    ...
                    b.Property<decimal?>("ResolutionQuantity")
                        .HasPrecision(18, 3)
                        .HasColumnType("numeric(18,3)");
                    ...
                    b.ToTable("StockTransfers", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_StockTransfers_Resolution", "(\"Status\" = 'Resolved' AND \"ResolvedByUserId\" IS NOT NULL AND \"ResolvedAt\" IS NOT NULL AND \"ResolutionDisposition\" IN ('AcceptedLoss', 'RecoveredAtDestination', 'ReturnedToSource') AND \"ResolutionQuantity\" > 0 AND length(btrim(\"ResolutionNotes\")) >= 3) OR (\"Status\" <> 'Resolved' AND \"ResolvedByUserId\" IS NULL AND \"ResolvedAt\" IS NULL AND \"ResolutionDisposition\" IS NULL AND \"ResolutionQuantity\" IS NULL AND \"ResolutionNotes\" IS NULL AND \"ResolutionEvidenceReference\" IS NULL)");

                            t.HasCheckConstraint("CK_StockTransfers_Status", "\"Status\" IN ('PendingDispatch', 'InTransit', 'Received', 'Disputed', 'Resolved')");
                        });
                });
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.MaterialCatalogRequest", b =>
                {
                    b.HasOne("ConstructionMS.Domain.Entities.Material", "ApprovedMaterial")
                        .WithMany()
