...
namespace ConstructionMS.Infrastructure.Migrations
{
    ...
    [Migration("20260909203730_AllowPoSelfApproval")]
    partial class AllowPoSelfApproval
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionMS.Domain.Entities.PurchaseOrder", b =>
                {
                    ...
                    b.ToTable("PurchaseOrders", t =>
                        {
                            t.HasCheckConstraint("CK_PurchaseOrders_Actors_Distinct", "(\"RejectedByUserId\" IS NULL OR \"RejectedByUserId\" <> \"CreatedByUserId\")");

                            t.HasCheckConstraint("CK_PurchaseOrders_CancellationActor", "\"Status\" <> 'Cancelled' OR ((\"ApprovedAt\" IS NOT NULL OR (\"SubmittedAt\" IS NOT NULL AND \"RejectedAt\" IS NULL)) AND \"CancelledByUserId\" <> \"CreatedByUserId\") OR ((\"ApprovedAt\" IS NULL AND (\"SubmittedAt\" IS NULL OR \"RejectedAt\" IS NOT NULL)) AND \"CancelledByUserId\" = \"CreatedByUserId\") OR (\"ApprovedByUserId\" = \"CreatedByUserId\" AND \"CancelledByUserId\" = \"CreatedByUserId\")");
